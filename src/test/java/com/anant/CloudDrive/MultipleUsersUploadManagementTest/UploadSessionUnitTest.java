...
public class UploadSessionUnitTest {
    ...
    final List<UploadRecord> UploadEntriesMocks = List.of(mock(UploadRecord.class),
    ...
    public void setup() {
        ...
        when(context.getBean(UploadRecord.class)).thenReturn(UploadEntriesMocks.get(0), UploadEntriesMocks.get(1), UploadEntriesMocks.get(2));
    }
    ...
    public void CorrectUploadEntriesAreBeingReturned() throws Exception {
        ...
        var _entry1 = session.getRecord(uploadId1);
        Assertions.assertEquals(UploadEntriesMocks.get(0),_entry1);

        var _entry2 = session.getRecord(uploadId2);
        Assertions.assertEquals(UploadEntriesMocks.get(1),_entry2);

        var _entry3 = session.getRecord(uploadId3);
    ...
    public void NullIsBeingReturnedForInvalidUploadId(){
        ...
        var invalidEntry = session.getRecord(invalidUploadId);
